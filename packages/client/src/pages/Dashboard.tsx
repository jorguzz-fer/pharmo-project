                        ...
                        <tbody className="divide-y divide-gray-100">
                            {[1, 2, 3, 4, 5].map((_, i) => (
                                <tr key={i} className="hover:bg-gray-50">
                                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">Ana Silva</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Thor (Golden)</td>
                                    <td className="px-6 py-4 whitespace-nowrap">Apoquel 5.4mg</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className="bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs font-medium">Enviado</span>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap">22 Dez, 14:30</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
