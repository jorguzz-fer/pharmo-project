...
var AnimalController = /** @class */ (function () {
    ...
    AnimalController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var schema, data, animal, error_1;
                ...
                switch (_a.label) {
                    case 0:
                        schema = zod_1.z.object({
                            ...
                            data_nascimento: zod_1.z.string().optional(), // ISO String
                        });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        ...
                        return [4 /*yield*/, prisma.animal.create({
                                data: __assign(__assign({}, data), { data_nascimento: data.data_nascimento ? new Date(data.data_nascimento) : undefined }),
                            })];
                    case 2:
                        animal = _a.sent();
                        return [2 /*return*/, res.status(201).json(animal)];
                    case 3:
                        error_1 = _a.sent();
    ...
    AnimalController.prototype.listByTutor = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var tutorId, animals, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        animals = _a.sent();
                        return [2 /*return*/, res.json(animals)];
                    case 3:
                        error_2 = _a.sent();
                        return [2 /*return*/, res.status(500).json({ error: 'Internal server error' })];
                    case 4: return [2 /*return*/];
