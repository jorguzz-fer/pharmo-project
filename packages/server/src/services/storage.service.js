...
function uploadFile(file, bucket, path) {
    return __awaiter(this, void 0, void 0, function () {
        var fileName, _a, data, error, publicUrl, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    fileName = "".concat(path, "/").concat(Date.now(), "_").concat(file.originalname);
                ...
                case 1:
                    ...
                    if (error) {
                        ...
                        return [2 /*return*/, { url: '', error: error.message }];
                    }
                ...
                case 2:
                    ...
                    return [2 /*return*/, { url: '', error: error_1.message }];
                case 3: return [2 /*return*/];
            }
        });
    });
}
function deleteFile(bucket, filePath) {
    return __awaiter(this, void 0, void 0, function () {
        var error, error_2;
